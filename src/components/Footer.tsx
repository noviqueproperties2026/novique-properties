    ...
    <div className="container py-14 grid gap-10 md:grid-cols-3">
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm">
          <li className="flex items-center gap-3"><Phone size={16} className="text-primary" /> +234 800 000 0000</li>
          <li className="flex items-center gap-3"><MessageCircle size={16} className="text-primary" /> WhatsApp: +234 800 000 0000</li>
          <li className="flex items-center gap-3"><Mail size={16} className="text-primary" /> hello@noviqueproperties.ng</li>
        </ul>
      </div>
